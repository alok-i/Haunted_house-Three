...
const ambientOcclusionTexture = textureLoader.load('/textures/door/ambientOcculsion.jpg')
const  metalnessTexture = textureLoader.load('/textures/door/metalness.jpg')
const roughnessTexture = textureLoader.load('/textures/door/roughness.jpg')

const bricksColorTexture = textureLoader.load('textures/bricks/color.jpg')
const bricksAmbientOcculsionTexture = textureLoader.load('textures/bricks/ambientOcculsion.jpg')
...
const tick = () =>
{
    ...
    ghost2.position.y = Math.sin(ghostAngle) * 4;
    ghost2.position.z = Math.sin(ghostAngle) * 4;

    ghost3.position.x = Math.cos(ghostAngle) * 4;
    ghost3.position.y = Math.sin(ghostAngle) * 4;
    ghost3.position.z = Math.sin(ghostAngle) * 4;
